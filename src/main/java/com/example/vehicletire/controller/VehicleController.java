...
public class VehicleController {
    ...
    @GetMapping
    public ResponseEntity<List<VehicleListResponseDTO>> listarTodosVeiculos() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<VehicleResponseDTO> buscarVeiculoPorId(@PathVariable Long id) throws Exception {
    ...
    @PostMapping
    public ResponseEntity<VehicleResponseDTO> criarVeiculo(@Valid @RequestBody VehicleCreateRequestDTO requestDTO) throws Exception {
    ...
    public ResponseEntity<Void> vincularPneu(
